...
export class TriviaController {
  ...
  @Post()
  create(@Request() req: any, @Body() createTriviaDto: CreateTriviaDto) {
    return this.triviaService.createTrivia(req.user.userId, createTriviaDto);
  }

  @Get('mine')
  findMyTrivias(@Request() req: any) {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Request() req: any, @Body() updateTriviaDto: UpdateTriviaDto) {
  ...
  @Post(':id/start')
  startTrivia(@Param('id') id: string, @Request() req: any) {
